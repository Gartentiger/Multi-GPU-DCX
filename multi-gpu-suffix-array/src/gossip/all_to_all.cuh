            ...
            for (uint src_gpu = 0; src_gpu < num_gpus; ++src_gpu) {
                for (uint dest_gpu = 0; dest_gpu < num_gpus; ++dest_gpu) {
                    ...
                    if (src_gpu == world_rank()) {
                        ...
                        ncclSend(from_k, sizeof(key_t) * c.len, ncclChar, dest_gpu, nccl_comm, mcontext.get_streams(src_gpu)[dest_gpu]);
                    ...
                    if (dest_gpu == world_rank()) {
                        ...
                        ncclRecv(to_k, sizeof(key_t) * c.len, ncclChar, src_gpu, nccl_comm, mcontext.get_streams(src_gpu)[dest_gpu]);
            ...
            for (uint src_gpu = 0; src_gpu < num_gpus; ++src_gpu) {
                for (uint dest_gpu = 0; dest_gpu < num_gpus; ++dest_gpu) {
                    ...
                    if (src_gpu == world_rank()) {
                        ...
                        ncclSend(from_v, sizeof(value_t) * c.len, ncclChar, dest_gpu, nccl_comm, mcontext.get_streams(src_gpu)[dest_gpu]);
                    ...
                    if (dest_gpu == world_rank()) {
                        ...
                        ncclRecv(to_v, sizeof(value_t) * c.len, ncclChar, src_gpu, nccl_comm, mcontext.get_streams(src_gpu)[dest_gpu]);
